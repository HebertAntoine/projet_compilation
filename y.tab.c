...
{
       0,   105,   105,   110,   125,   126,   129,   130,   133,   136,
     137,   138,   141,   142,   145,   146,   149,   153,   154,   158,
...
#line 130 "grammar.y"
                                            { (yyval.ptr) = noed_LIST((yyvsp[-1].ptr), (yyvsp[0].ptr)); }
#line 1509 "y.tab.c"
    break;

  case 8: /* vardecl: type listtypedecl TOK_SEMICOL  */
#line 133 "grammar.y"
                                            { (yyval.ptr) = noed_DECLS((yyvsp[-2].ptr), (yyvsp[-1].ptr)); }
#line 1515 "y.tab.c"
    break;
...
#line 142 "grammar.y"
                                            { (yyval.ptr) = noed_COMMA((yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1545 "y.tab.c"
    break;
...
#line 146 "grammar.y"
                                            { (yyval.ptr) = noed_AFFECT((yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1557 "y.tab.c"
    break;

  case 16: /* maindecl: type ident TOK_LPAR TOK_RPAR block  */
#line 150 "grammar.y"
        { (yyval.ptr) = make_node_3(NODE_FUNC, (yyvsp[-4].ptr), (yyvsp[-3].ptr), (yyvsp[0].ptr)); }
#line 1563 "y.tab.c"
    break;
...
#line 162 "grammar.y"
                                                                                { (yyval.ptr) = noed_SEMICAL((yyvsp[-1].ptr)); }
#line 1593 "y.tab.c"
    break;

  case 22: /* inst: TOK_IF TOK_LPAR expr TOK_RPAR inst TOK_ELSE inst  */
#line 163 "grammar.y"
                                                                                { (yyval.ptr) = make_node_3(NODE_IF, (yyvsp[-4].ptr), (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1599 "y.tab.c"
    break;

  case 23: /* inst: TOK_IF TOK_LPAR expr TOK_RPAR inst  */
#line 164 "grammar.y"
                                                                                { (yyval.ptr) = make_node_2(NODE_IF, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1605 "y.tab.c"
    break;

  case 24: /* inst: TOK_WHILE TOK_LPAR expr TOK_RPAR inst  */
#line 165 "grammar.y"
                                                                                { (yyval.ptr) = noed_WHILE((yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1611 "y.tab.c"
    break;

  case 25: /* inst: TOK_FOR TOK_LPAR expr TOK_SEMICOL expr TOK_SEMICOL expr TOK_RPAR inst  */
#line 166 "grammar.y"
                                                                                { (yyval.ptr) = make_node_4(NODE_FOR, (yyvsp[-6].ptr), (yyvsp[-4].ptr), (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1617 "y.tab.c"
    break;

  case 26: /* inst: TOK_DO inst TOK_WHILE TOK_LPAR expr TOK_RPAR TOK_SEMICOL  */
#line 167 "grammar.y"
                                                                                { (yyval.ptr) = noed_DOWHILE((yyvsp[-5].ptr), (yyvsp[-2].ptr)); }
#line 1623 "y.tab.c"
    break;
...
#line 170 "grammar.y"
                                                                                { (yyval.ptr) = noed_PRINT((yyvsp[-2].ptr)); }
#line 1641 "y.tab.c"
    break;

  case 30: /* block: TOK_LACC listdecl listinst TOK_RACC  */
#line 173 "grammar.y"
                                              { (yyval.ptr) = noed_LACC((yyvsp[-2].ptr), (yyvsp[-1].ptr)); }
#line 1647 "y.tab.c"
    break;

  case 31: /* expr: expr TOK_MUL expr  */
#line 176 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_MUL, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1653 "y.tab.c"
    break;

  case 32: /* expr: expr TOK_DIV expr  */
#line 177 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_DIV, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1659 "y.tab.c"
    break;

  case 33: /* expr: expr TOK_PLUS expr  */
#line 178 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_PLUS, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1665 "y.tab.c"
    break;

  case 34: /* expr: expr TOK_MINUS expr  */
#line 179 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_MINUS, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1671 "y.tab.c"
    break;

  case 35: /* expr: expr TOK_MOD expr  */
#line 180 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_MOD, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1677 "y.tab.c"
    break;

  case 36: /* expr: expr TOK_LT expr  */
#line 181 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_LT, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1683 "y.tab.c"
    break;

  case 37: /* expr: expr TOK_GT expr  */
#line 182 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_GT, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1689 "y.tab.c"
    break;

  case 38: /* expr: TOK_MINUS expr  */
#line 183 "grammar.y"
                                          { (yyval.ptr) = make_node_1(NODE_UMINUS, (yyvsp[0].ptr)); }
#line 1695 "y.tab.c"
    break;

  case 39: /* expr: expr TOK_GE expr  */
#line 184 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_GE, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1701 "y.tab.c"
    break;

  case 40: /* expr: expr TOK_LE expr  */
#line 185 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_LE, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1707 "y.tab.c"
    break;

  case 41: /* expr: expr TOK_EQ expr  */
#line 186 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_EQ, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1713 "y.tab.c"
    break;

  case 42: /* expr: expr TOK_NE expr  */
#line 187 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_NE, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1719 "y.tab.c"
    break;

  case 43: /* expr: expr TOK_AND expr  */
#line 188 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_AND, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1725 "y.tab.c"
    break;

  case 44: /* expr: expr TOK_OR expr  */
#line 189 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_OR, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1731 "y.tab.c"
    break;

  case 45: /* expr: expr TOK_BAND expr  */
#line 190 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_BAND, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1737 "y.tab.c"
    break;

  case 46: /* expr: expr TOK_BOR expr  */
#line 191 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_BOR, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1743 "y.tab.c"
    break;

  case 47: /* expr: expr TOK_BXOR expr  */
#line 192 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_BXOR, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1749 "y.tab.c"
    break;

  case 48: /* expr: expr TOK_SRL expr  */
#line 193 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_SRL, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1755 "y.tab.c"
    break;

  case 49: /* expr: expr TOK_SRA expr  */
#line 194 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_SRA, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1761 "y.tab.c"
    break;

  case 50: /* expr: expr TOK_SLL expr  */
#line 195 "grammar.y"
                                    { (yyval.ptr) = make_node_2(NODE_SLL, (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1767 "y.tab.c"
    break;

  case 51: /* expr: TOK_NOT expr  */
#line 196 "grammar.y"
                                    { (yyval.ptr) = make_node_1(NODE_NOT, (yyvsp[0].ptr)); }
#line 1773 "y.tab.c"
    break;

  case 52: /* expr: TOK_BNOT expr  */
#line 197 "grammar.y"
                                    { (yyval.ptr) = make_node_1(NODE_BNOT, (yyvsp[0].ptr)); }
#line 1779 "y.tab.c"
    break;

  case 53: /* expr: TOK_LPAR expr TOK_RPAR  */
#line 198 "grammar.y"
                                    { (yyval.ptr) = noed_LPAR((yyvsp[-1].ptr)); }
#line 1785 "y.tab.c"
    break;
...
#line 200 "grammar.y"
                                    { (yyval.ptr) = noed_INTVAL((yyvsp[0].intval)); }
#line 1797 "y.tab.c"
    break;
...
#line 206 "grammar.y"
                                                     { (yyval.ptr) = noed_LIST((yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1821 "y.tab.c"
    break;
...
#line 211 "grammar.y"
                     { (yyval.ptr) = noed_stringval((yyvsp[0].strval)); }
#line 1839 "y.tab.c"
    break;

  case 63: /* ident: TOK_IDENT  */
#line 214 "grammar.y"
                    { (yyval.ptr) = noed_ident((yyvsp[0].strval)); }
#line 1845 "y.tab.c"
    break;
